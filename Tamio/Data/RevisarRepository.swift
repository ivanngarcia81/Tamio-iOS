    ...
    private static var semilla: [Revision] {
        [
            Revision(id: 1, tipo: .vistoBueno, concepto: L.t("Ofrenda del domingo", "Sunday offering"),
                     ...
                     seccionTitulo: L.t("EL INGRESO", "THE INCOME"),
                     campos: [
                        .init(label: L.t("Concepto", "Concept"), valor: L.t("Ofrenda del domingo", "Sunday offering")),
                        .init(label: L.t("Importe", "Amount"), valor: "+$8,420.00 MXN", resalte: .verde),
            ...
            Revision(id: 2, tipo: .vistoBueno, concepto: L.t("Compra de sillas", "Chairs purchase"),
                     ...
                     seccionTitulo: L.t("EL GASTO", "THE EXPENSE"),
                     campos: [
                        .init(label: L.t("Concepto", "Concept"), valor: L.t("Compra de sillas", "Chairs purchase")),
                        .init(label: L.t("Importe", "Amount"), valor: "−$6,900.00 MXN", resalte: .rojo),
            ...
            Revision(id: 3, tipo: .sinComprobante, concepto: L.t("Mantenimiento del aire", "AC maintenance"),
                     ...
                     campos: [
                        ...
                        .init(label: L.t("Importe", "Amount"), valor: "−$4,350.00 MXN", resalte: .rojo),
            ...
            Revision(id: 4, tipo: .duplicado, concepto: L.t("Renta del anexo", "Annex rent"),
                     ...
                     campos: [
                        ...
                        .init(label: L.t("Importe", "Amount"), valor: "−$3,500.00 MXN", resalte: .rojo),
                     ...
                     seccionSecundaria: L.t("EL OTRO MOVIMIENTO", "THE OTHER ENTRY"),
                     camposSecundarios: [
                        .init(label: L.t("Concepto", "Concept"), valor: L.t("Renta del anexo", "Annex rent")),
                        .init(label: L.t("Importe", "Amount"), valor: "−$3,500.00 MXN", resalte: .rojo),
            ...
            Revision(id: 5, tipo: .categoriaVacia, concepto: L.t("Depósito varios", "Misc deposit"),
                     ...
                     campos: [
                        ...
                        .init(label: L.t("Importe", "Amount"), valor: "+$1,180.00 MXN", resalte: .verde),
            ...
            Revision(id: 6, tipo: .sinVincular, concepto: L.t("Diezmo", "Tithe"),
                     ...
                     campos: [
                        ...
                        .init(label: L.t("Importe", "Amount"), valor: "+$2,400.00 MXN", resalte: .verde),
            ...
            Revision(id: 7, tipo: .recurrenteVencido, concepto: L.t("Renta del anexo", "Annex rent"),
                     detalleLista: L.t("Renta del anexo · 2 meses sin generar", "Annex rent · 2 months not generated"),
                     ...
                     seccionTitulo: L.t("LA SERIE", "THE SERIES"),
                     campos: [
                        .init(label: L.t("Concepto", "Concept"), valor: L.t("Renta del anexo", "Annex rent")),
                        .init(label: L.t("Tipo", "Type"), valor: L.t("Gasto", "Expense")),
                        .init(label: L.t("Importe por mes", "Amount per month"), valor: "$3,500.00 MXN", resalte: .rojo),
                     ...
                     acciones: [resolver("Ver movimientos recurrentes", "See recurring entries")]),

            Revision(id: 8, tipo: .faltaFirma, concepto: L.t("Miércoles 19 de agosto", "Wednesday Aug 19"),
                     detalleLista: L.t("Miércoles 19 de agosto · 19 ago 2026", "Wednesday Aug 19 · Aug 19, 2026"),
                     ...
                     campos: [
                        ...
                        .init(label: L.t("Importe contado", "Counted amount"), valor: "$4,310.00 MXN"),
                     ...
                     acciones: [resolver("Ir al corte", "Go to the cut")]),
            ...
            Revision(id: 9, tipo: .archivado, concepto: "Carmen Ortiz Salinas",
                     ...
                     seccionTitulo: L.t("EL MIEMBRO", "THE MEMBER"),
                     campos: [
