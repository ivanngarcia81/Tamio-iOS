...
struct MockAgendaRepository: AgendaRepository {
    ...
    private static let semilla: [EventoAgenda] = [
            ...
            EventoAgenda(id: "6",  dia: 16, hora: nil,     titulo: L.t("Depósito bancario", "Bank deposit"),             descripcion: L.t("Banorte · pendiente", "Chase · pending"),            tipo: .deposito, completado: true),
            ...
            EventoAgenda(id: "13", dia: 23, hora: nil,     titulo: L.t("Depósito bancario", "Bank deposit"),             descripcion: L.t("Banorte · 14 movimientos sin depositar", "Chase · 14 undeposited transactions"), tipo: .deposito, completado: false),
