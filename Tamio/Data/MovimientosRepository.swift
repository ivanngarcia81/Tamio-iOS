...
struct MockMovimientosRepository: MovimientosRepository {
    ...
    private static var semilla: [Movimiento] {
        var v: [Movimiento] = []
        v += [
            Movimiento(id: 1, tipo: .ingreso, categoria: "Diezmo", persona: "María Hernández",
                folio: "1043", metodo: "Efectivo", monto: 1_200_00, hora: "11:20", fecha: dias(0),
                ...
                auditoria: [
                    AuditEntry(id: 1, titulo: L.t("Creado · Iván García", "Created · Iván García"),
                               detalle: L.t("20 de agosto 2026, 11:20 · iPad", "Aug 20, 2026, 11:20 · iPad")),
            ...
            Movimiento(id: 2, tipo: .ingreso, categoria: L.t("Ofrenda misionera", "Mission offering"), persona: nil,
                folio: "1041", metodo: "Efectivo", monto: 6_845_00, hora: "12:05", fecha: dias(0),
                ...
                auditoria: [AuditEntry(id: 1, titulo: L.t("Creado · Iván García", "Created · Iván García"),
                                       detalle: L.t("20 de agosto 2026, 12:05 · iPad", "Aug 20, 2026, 12:05 · iPad"))]),
            Movimiento(id: 3, tipo: .ingreso, categoria: "Diezmo", persona: L.t("Familia Ruvalcaba", "Ruvalcaba family"),
            ...
            Movimiento(id: 5, tipo: .ingreso, categoria: "Diezmo", persona: "Pedro Salas",
                ...
                categoriaCompleta: L.t("Diezmos · fondo general", "Tithes · general fund"), nota: nil,
                sinDepositar: false, comprobante: nil, auditoria: []),
            Movimiento(id: 6, tipo: .ingreso, categoria: "Diezmo", persona: "Ana Lucía Torres",
                folio: "1037", metodo: "Efectivo", monto: 1_450_00, hora: "19:10", fecha: dias(1),
                registradoPor: "Iván García", miembro: "Ana Lucía Torres",
                categoriaCompleta: L.t("Diezmos · fondo general", "Tithes · general fund"), nota: nil,
                sinDepositar: false, comprobante: nil, auditoria: []),
            Movimiento(id: 7, tipo: .ingreso, categoria: "Misiones", persona: L.t("ofrenda especial", "special offering"),
                folio: "1036", metodo: "Efectivo", monto: 7_248_00, hora: "11:00", fecha: dias(4),
                registradoPor: "Iván García", miembro: nil,
                categoriaCompleta: L.t("Misiones · ofrenda", "Missions · offering"), nota: nil,
                sinDepositar: false, comprobante: nil, auditoria: []),
            Movimiento(id: 8, tipo: .ingreso, categoria: L.t("Ofrenda de gratitud", "Thanksgiving offering"), persona: nil,
                folio: "1035", metodo: "Efectivo", monto: 540_00, hora: "11:05", fecha: dias(4),
                registradoPor: "Iván García", miembro: nil,
                categoriaCompleta: L.t("Ofrendas · culto", "Offerings · service"), nota: nil,
                sinDepositar: false, comprobante: nil, auditoria: []),
            Movimiento(id: 101, tipo: .gasto, categoria: "Utilidades", persona: "Luz CFE",
